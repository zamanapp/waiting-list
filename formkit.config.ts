...
const boxClassification = {
  ...
  help: "mb-2",
  input:
    "appearance-none h-5 w-5 me-2 border border-gray-400 rounded-sm bg-white checked:bg-black hover:border-black checked:hover:bg-gray-700 checked:focus:bg-gray-700 focus:outline-none focus:ring-0 transition duration-200",
...
const buttonClassification = {
  wrapper: "my-6 ",
  input:
    "w-full bg-black disabled:bg-gray-400 disabled:cursor-not-allowed hover:bg-gray-700 rounded-md text-white text-xl font-normal py-3 px-6",
};
...
const config: DefaultConfigOptions = {
  ...
  `,
    solidEyeClose: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
